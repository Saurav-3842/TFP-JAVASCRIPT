const data = {
  ...
  const divP = new DocumentFragment();
  let i=-1;
  data.recipes.forEach(({id,name,ingredients,instructions,prepTimeMinutes,cookTimeMinutes,servings,difficulty,cuisine,caloriesPerServing,tags,userId,image,rating,reviewCount,mealType})=>{
    const card = document.createElement("div");
    card.className="card";
    card.innerHTML=`<p><strong>Reciept ID:</strong> ${id}</p>
                    <p><strong>Name:</strong> ${name}</p>
                    <p><strong>Ingredints</strong>: ${ingredients}</p>
                    <p><strong>Instructions:</strong> ${instructions}</p>
                    <p><strong>PrepTimeMinutes:</strong> ${prepTimeMinutes}</p>
                    <p><strong>CookTimeMinutes:</strong> ${cookTimeMinutes}</p>
                    <p><strong>Servings:</strong> ${servings}</p>
                    <p><strong>Difficulty:</strong> ${difficulty}</p>
                    <p><strong>Cuisine:</strong> ${cuisine}</p>
                    <p><strong>CaloriesPerServing:</strong> ${caloriesPerServing}</p>
                    ...
                    <button id="${i+=1}" onClick="dltfunc(event)">Delete</button>`;
