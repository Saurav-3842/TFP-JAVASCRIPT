...
// for(const prop in array2){
//     console.log(array2[prop].name);
//     console.log(array2[prop].cuisine);
// }
...
{
  forLoop2a.push({
    recipeName:data.recipes[i].name,
    cuisineName:data.recipes[i].cuisine})
  // console.log(data.recipes[i].name);
  // console.log(data.recipes[i].cuisine);
}
console.log(forLoop2a);

//-------------------------TABLE FOR LOOP 2A i --------------------------------------

const FORLOOP2A = document.getElementById("ForLoop");
...
const table2ai = document.createElement("table");
table2ai.border = "2"; 
table2ai.style.borderCollapse = "collapse";
table2ai.style.margin ="auto";

// Step 3: Create table2ai headers
const headerRow2ai = document.createElement("tr");
headerRow2ai.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; // Optional: Align text in headers
    headerRow2ai.appendChild(th);
});

table2ai.appendChild(headerRow2ai); // Append headers to the table2ai

// Step 4: Populate the table2ai with data
forLoop2a.forEach(recipe => {
    const row = document.createElement("tr");

    // Create cells for recipeName and cuisineName
    ...
    table2ai.appendChild(row); // Append the row to the table2ai
});
// Step 5: Append the table2ai to the div
FORLOOP2A.appendChild(table2ai);


//*************************delete*****************************/
const buttonforloop = document.createElement("BUTTON");
buttonforloop.style.margin ="auto";

const t = document.createTextNode("Click me");
buttonforloop.appendChild(t);
FORLOOP2A.appendChild(buttonforloop);
let displayfun=(e)=>{
  if(e.target==buttonforloop){
    FORLOOP2A.innerHTML="";
  }
console.log(forLoop2a);
  
}
buttonforloop.addEventListener("click",displayfun);
...
data.recipes.forEach((item)=>{
  forEach2a.push({recipeName:item.name,cuisineName:item.cuisine})
});

//----------------------------TABLE FOREACH 2A ii--------------------------------------------

const FOREACH2A = document.getElementById("ForEach2a");
const table2aii = document.createElement("table");
table2aii.border = "2"; 
table2aii.style.borderCollapse = "collapse";
table2aii.style.margin ="auto";

const headerRow2aii = document.createElement("tr");
headerRow2aii.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2aii.appendChild(th);
});

table2aii.appendChild(headerRow2aii);

forEach2a.forEach(recipe => {
    const row = document.createElement("tr");
    ...
    table2aii.appendChild(row);
});

FOREACH2A.appendChild(table2aii);


// console.log(forEach2a);

//-----------------------------------------------------------------------------------------------

let map2a=data.recipes.map((item)=>{
  return {recipeName:item.name,cuisineName:item.cuisine}
});
// console.log(map2a);

//--------------------------------------TABLE MAP 2A iii------------------------------------------

const MAP2A = document.getElementById("Map2a");
const table2aiii = document.createElement("table");
table2aiii.border = "2"; 
table2aiii.style.borderCollapse = "collapse";
table2aiii.style.margin ="auto";

const headerRow2aiii = document.createElement("tr");
headerRow2aiii.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2aiii.appendChild(th);
});

table2aiii.appendChild(headerRow2aiii);

map2a.forEach(recipe => {
    const row = document.createElement("tr");
    ...
    table2aiii.appendChild(row);
});

MAP2A.appendChild(table2aiii);
...
// console.log(forLoop2b);
//----------------------------TABLE FORLOOP 2A ii--------------------------------------------

const FORLOOP2B = document.getElementById("ForLoop2b");
const table2bi = document.createElement("table");
table2bi.border = "2"; 
table2bi.style.borderCollapse = "collapse";
table2bi.style.margin ="auto";

const headerRow2bi = document.createElement("tr");
headerRow2bi.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2bi.appendChild(th);
});

table2bi.appendChild(headerRow2bi);

forLoop2b.forEach(recipe => {
    const row = document.createElement("tr");
    ...
    table2bi.appendChild(row);
});

FORLOOP2B.appendChild(table2bi);
//-----------------------------------------------------------------------------------------------

let forEach2b = [];
data.recipes.forEach((item)=>{
  if(item.rating>4.5){
  forEach2b.push({recipeName:item.name,cuisineName:item.cuisine})}
});

// console.log(forEach2b);
//---------------------------------TABLE FOREACH 2B ii--------------------------------------------

const FOREACH2B = document.getElementById("ForEach2b");
const table2bii = document.createElement("table");
table2bii.border = "2"; 
table2bii.style.borderCollapse = "collapse";
table2bii.style.margin ="auto";

const headerRow2bii = document.createElement("tr");
headerRow2bii.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2bii.appendChild(th);
});

table2bii.appendChild(headerRow2bii);

forEach2b.forEach(recipe => {
    const row = document.createElement("tr");
    ...
    table2bii.appendChild(row);
});

FOREACH2B.appendChild(table2bii);
//-----------------------------------------------------------------------------------------------

let map2b=data.recipes.filter((item)=> item.rating>4.5).map((item)=>{
  return {recipeName:item.name,cuisineName:item.cuisine}
});
// console.log(map2b);

//-------------------------------------TABLE MAP 2A iii------------------------------------------
const MAP2B = document.getElementById("Map2b");
const table2biii = document.createElement("table");
table2biii.border = "2"; 
table2biii.style.borderCollapse = "collapse";
table2biii.style.margin ="auto";

const headerRow2biii = document.createElement("tr");
headerRow2biii.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2biii.appendChild(th);
});

table2biii.appendChild(headerRow2biii);

map2b.forEach(recipe => {
    const row = document.createElement("tr");
    ...
    table2biii.appendChild(row);
});

MAP2B.appendChild(table2biii);

//-----------------------------------------------------------------------------------------------


//
let flatMap2b = data.recipes.flatMap((item)=>{if(item.rating<=4.5){return []}return {recipeName:item.name,cuisineName:item.cuisine}});
// console.log(flatMap2b);

//-------------------------------------TABLE FLATMAP 2A iii------------------------------------------

const FLATMAP2B = document.getElementById("FlatMap2b");
const table2biv = document.createElement("table");
table2biv.border = "2"; 
table2biv.style.borderCollapse = "collapse";
table2biv.style.margin ="auto";

const headerRow2biv = document.createElement("tr");
headerRow2biv.style.backgroundColor ="red"; 
["Recipe Name", "Cuisine Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2biv.appendChild(th);
});

table2biv.appendChild(headerRow2biv);

flatMap2b.forEach(recipe => {
    const row = document.createElement("tr");
    ...
    table2biv.appendChild(row);
});

FLATMAP2B.appendChild(table2biv);

//-----------------------------------------------------------------------------------------------

let forEach2c = [];
data.recipes.forEach((item)=>{
  let tag = item.tags.forEach((t)=>{if(t ==="Indian" || t==="Italian"){forEach2c.push({recipeName:item.name})}})
  });
// console.log(forEach2c);
//2   C
//-------------------------------------TABLE FLATMAP 2C iii------------------------------------------

const FOREACH2C = document.getElementById("ForEach2c");
const table2ci = document.createElement("table");
table2ci.border = "2"; 
table2ci.style.borderCollapse = "collapse";
table2ci.style.margin ="auto";

const headerRow2ci = document.createElement("tr");
headerRow2ci.style.backgroundColor ="red"; 
["Recipe Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2ci.appendChild(th);
});

table2ci.appendChild(headerRow2ci);

forEach2c.forEach(recipe => {
  const row = document.createElement("tr");
  ...
  table2ci.appendChild(row);
});

FOREACH2C.appendChild(table2ci);

//-----------------------------------------------------------------------------------------------


let flatMap2c = data.recipes.flatMap((item)=>{
    let array = item.tags.flatMap((tag)=>{if(tag ==="Indian" || tag==="Italian"){return item.name} else {return []}})
    return array;
});
 
// console.log(flatMap2c);


//-------------------------------------TABLE FLATMAP 2C iii------------------------------------------

const FLATMAP2C = document.getElementById("FlatMap2c");
const table2ciii = document.createElement("table");
table2ciii.border = "2"; 
table2ciii.style.borderCollapse = "collapse";
table2ciii.style.margin ="auto";

const headerRow2ciii = document.createElement("tr");
headerRow2ciii.style.backgroundColor ="red"; 
["Recipe Name"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2ciii.appendChild(th);
});

table2ciii.appendChild(headerRow2ciii);

flatMap2c.forEach(recipe => {
    const row = document.createElement("tr");
    const recipeCell = document.createElement("td");
    recipeCell.textContent = recipe;
    row.appendChild(recipeCell);
    table2ciii.appendChild(row);
});

FLATMAP2C.appendChild(table2ciii);

//-----------------------------------------------------------------------------------------------


// let map2c = data.recipes.filter((item)=>)

// let map2c = data.recipes.map((item)=>{
//   let
// })
//---------------------------QUES D------------------------------------
...
const counter={};
data.recipes.forEach((item)=>{
  let tag = item.tags.forEach((t)=>{
    if(counter[t]){counter[t]+=1;}
    else{counter[t]=1;}
  })
  });
console.log(counter);

const Frequency = document.getElementById("Frequency2d");
const table2d = document.createElement("table");
table2d.border = "2"; 
table2d.style.borderCollapse = "collapse";
table2d.style.margin ="auto";

const headerRow2d = document.createElement("tr");
headerRow2d.style.backgroundColor ="red"; 
["Tag Name","Frequency"].forEach(header => {
    const th = document.createElement("th");
    th.textContent = header;
    th.style.textAlign = "left"; 
    headerRow2d.appendChild(th);
});

table2d.appendChild(headerRow2d);

Object.entries(counter).forEach(([category, count]) => {
  const row = document.createElement("tr");
  ...
  table2d.appendChild(row); 
});

Frequency.appendChild(table2d);